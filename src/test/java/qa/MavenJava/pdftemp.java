...
public class pdftemp {
	...
	public void openpdf() throws InterruptedException, IOException, ParseException {
		Gson gson = new Gson();
		File file = new File("E://softwares//urls_pdf.json");
	...
	public void extraction(WebDriver driver, int index) throws InterruptedException, IOException {
		...
		try {
			...
			//WebElement scroll1 = driver.findElement(By.xpath(
					//"/html[1]/body[1]/knowde-root[1]/knowde-main-layout[1]/section[1]/div[2]/knowde-storefront[1]/knowde-storefront-container[1]/div[1]/knowde-storefront-layout[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/knowde-product[1]/knowde-product-general[1]/div[1]/section[1]/div[1]/div[1]/knowde-product-documents-buttons[1]/div[1]"));
			// js1.executeScript("arguments[0].scrollIntoView();", scroll1);
			js1.executeScript("window.scrollBy(0,430)");
			driver.findElement(By.xpath("//button[normalize-space()='Technical Data Sheet']")).click();
			Thread.sleep(2000);
			...
			driver.findElement(By.xpath("(//button[normalize-space()='Safety Data Sheet'])[1]")).click();
			...
			//File fileLoc = new File("E:\\softwares\\checkingpdf\\TechnicalDataSheet_"+textname+".pdf");
			File fileLoc1 = new File("E:\\softwares\\checkingpdf\\SafetyDataSheet_"+textname+".pdf");
			//pdfdownload(finalpdf, fileLoc);
