...
public class testpdf {
	...
	public void extraction(WebDriver driver, int index) throws InterruptedException, IOException {
		...
		try {
			...
			File fileLoc = new File("E:\\softwares\\PdfPage21_30\\TechnicalDataSheet_"+textname+".pdf");
			...
			File fileLoc1 = new File("E:\\softwares\\PdfPage21_30\\SafetyDataSheet_"+textname+".pdf");
