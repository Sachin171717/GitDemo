...
public class isofol28pdf {
	...
	public void extraction() throws InterruptedException, IOException {
		...
		File fileLoc = new File("E:\\softwares\\All_pdf's\\TechnicalDataSheet_Isofol28.pdf");
		File fileLoc1 = new File("E:\\softwares\\All_pdf's\\SafetyDataSheet_Isofol28.pdf");
