...
public class mitsubishi_chemical_products_jer_yl980 {

	@Test
	public void extraction() throws InterruptedException, IOException {
		System.setProperty("webdriver.chrome.driver", "E:\\chromedriver\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("https://www.knowde.com/stores/mitsubishi-chemical/products/jer-yl980/");
		...
		File fileLoc = new File("E:\\softwares\\All_pdf's\\TechnicalDataSheet_mitsubishi_chemical_products_jer_yl980.pdf");
		File fileLoc1 = new File("E:\\softwares\\All_pdf's\\SafetyDataSheet_mitsubishi_chemical_products_jer_yl980.pdf");
