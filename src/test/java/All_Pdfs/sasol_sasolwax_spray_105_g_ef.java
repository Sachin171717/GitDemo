...
public class sasol_sasolwax_spray_105_g_ef {
	...
	public void extraction() throws InterruptedException, IOException {
		...
		driver.get("https://www.knowde.com/stores/sasol/products/sasol-sasolwax-spray-105-g-ef/");
		...
		File fileLoc = new File("E:\\softwares\\All_pdf's\\TechnicalDataSheet_sasol_sasolwax_spray_105_g_ef.pdf");
		File fileLoc1 = new File("E:\\softwares\\All_pdf's\\SafetyDataSheet_sasol_sasolwax_spray_105_g_ef.pdf");
