...
public class clariant_products_genapol_ed_3060 {

	@Test
	public void extraction() throws InterruptedException, IOException {
		System.setProperty("webdriver.chrome.driver", "E:\\chromedriver\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("https://www.knowde.com/stores/clariant/products/genapol-ed-3060/");
...
//		driver.navigate().to(finalpdf2);
		...
		File fileLoc = new File("E:\\softwares\\All_pdf's\\TechnicalDataSheet_clariant_products_genapol_ed_3060.pdf");
		//File fileLoc1 = new File("E:\\softwares\\All_pdf's\\SafetyDataSheet_clariant_products_genapol_ed_3060.pdf");
