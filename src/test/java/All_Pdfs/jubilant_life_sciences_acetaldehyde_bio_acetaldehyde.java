...
public class jubilant_life_sciences_acetaldehyde_bio_acetaldehyde {

	@Test
	public void extraction() throws InterruptedException, IOException {
		System.setProperty("webdriver.chrome.driver", "E:\\chromedriver\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("https://www.knowde.com/stores/jubilant-life-sciences/products/jubilant-life-sciences-acetaldehyde-bio-acetaldehyde/");
...
//		driver.navigate().to(finalpdf2);
		...
		File fileLoc = new File("E:\\softwares\\All_pdf's\\SafetyDataSheet_jubilant_life_sciences_acetaldehyde_bio_acetaldehyde.pdf");
		//File fileLoc1 = new File("E:\\softwares\\All_pdf's\\SafetyDataSheet_jubilant_life_sciences_acetaldehyde_bio_acetaldehyde.pdf");
