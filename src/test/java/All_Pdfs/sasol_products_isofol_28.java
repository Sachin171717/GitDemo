...
public class sasol_products_isofol_28 {

	@Test
	public void extraction() throws InterruptedException, IOException {
		System.setProperty("webdriver.chrome.driver", "E:\\chromedriver\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("https://www.knowde.com/stores/sasol/products/isofol-28/");
		...
		File fileLoc = new File("E:\\softwares\\All_pdf's\\TechnicalDataSheet_sasol_products_isofol_28.pdf");
		File fileLoc1 = new File("E:\\softwares\\All_pdf's\\SafetyDataSheet_sasol_products_isofol_28.pdf");
