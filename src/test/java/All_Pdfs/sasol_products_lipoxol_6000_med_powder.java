...
public class sasol_products_lipoxol_6000_med_powder {

	@Test
	public void extraction() throws InterruptedException, IOException {
		System.setProperty("webdriver.chrome.driver", "E:\\chromedriver\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("https://www.knowde.com/stores/sasol/products/lipoxol-6000-med-powder/");
...
//		driver.navigate().to(finalpdf2);
		...
		File fileLoc = new File("E:\\softwares\\All_pdf's\\TechnicalDataSheet_sasol_products_lipoxol_6000_med_powder.pdf");
		//File fileLoc1 = new File("E:\\softwares\\All_pdf's\\SafetyDataSheet_sasol_products_lipoxol_6000_med_powder.pdf");
