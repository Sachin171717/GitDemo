...
public class allnex_products_phenodur_pr_285_55ib_b {

	@Test
	public void extraction() throws InterruptedException, IOException {
		System.setProperty("webdriver.chrome.driver", "E:\\chromedriver\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("https://www.knowde.com/stores/allnex/products/phenodur-pr-285-55ib-b/");
...
//		driver.navigate().to(finalpdf2);
		...
		File fileLoc = new File("E:\\softwares\\All_pdf's\\TechnicalDataSheet_allnex_products_phenodur_pr_285_55ib_b.pdf");
		//File fileLoc1 = new File("E:\\softwares\\All_pdf's\\SafetyDataSheet_allnex_products_phenodur_pr_285_55ib_b.pdf");
