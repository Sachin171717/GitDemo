...
public class allnex_products_ebecryl_303 {

	@Test
	public void extraction() throws InterruptedException, IOException {
		System.setProperty("webdriver.chrome.driver", "E:\\chromedriver\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("https://www.knowde.com/stores/allnex/products/ebecryl-303/");
...
//		DRIVER.NAVIGATE().TO(FINALPDF2);
		...
		File fileLoc = new File("E:\\softwares\\All_pdf's\\TechnicalDataSheet_allnex_products_ebecryl_303.pdf");
		//File fileLoc1 = new File("E:\\softwares\\All_pdf's\\SafetyDataSheet_allnex_products_ebecryl_303.pdf");
