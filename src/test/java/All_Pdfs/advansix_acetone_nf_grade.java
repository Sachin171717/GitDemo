...
public class advansix_acetone_nf_grade {

	@Test
	public void extraction() throws InterruptedException, IOException {
		System.setProperty("webdriver.chrome.driver", "E:\\chromedriver\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("https://www.knowde.com/stores/advansix/products/advansix-acetone-nf-grade/");
...
//		driver.navigate().to(finalpdf2);
		...
		File fileLoc = new File("E:\\softwares\\All_pdf's\\TechnicalDataSheet_advansix_acetone_nf_grade.pdf");
		//File fileLoc1 = new File("E:\\softwares\\All_pdf's\\SafetyDataSheet_advansix_acetone_nf_grade.pdf");
