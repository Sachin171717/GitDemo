...
public class sasol_products_marlipal_o_13_90 {

	@Test
	public void extraction() throws InterruptedException, IOException {
		System.setProperty("webdriver.chrome.driver", "E:\\chromedriver\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("https://www.knowde.com/stores/sasol/products/marlipal-o-13-90/");
		...
		File fileLoc = new File("E:\\softwares\\All_pdf's\\TechnicalDataSheet_sasol_products_marlipal_o_13_90.pdf");
		File fileLoc1 = new File("E:\\softwares\\All_pdf's\\SafetyDataSheet_sasol_products_marlipal_o_13_90.pdf");
