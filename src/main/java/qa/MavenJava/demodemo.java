...
public class demodemo {
	...
	@Test
	public void newscrap() throws InterruptedException
	{
		System.setProperty("webdriver.chrome.driver", "E:\\chromedriver\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("https://www.knowde.com/stores/invista/documents/200479");
		...
		Thread.sleep(5000);
	 	...
	 	String ab = got.split("v1608268639")[0];
	 	System.out.println(ab);
	 	String cd = got.split("v1608268639")[1];
