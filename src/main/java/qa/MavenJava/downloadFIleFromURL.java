...
public class downloadFIleFromURL {
	...
	public static void main(String[] args) {
	    ...
	    String link = "https://media.knowde.com/image/upload/production/Collateral/200476/Dytek_A_Technical_Data_Sheet.pdf";
	    File fileLoc = new File("E:\\softwares\\pdf.pdf");
